...
namespace CustomerOnboarding.Tests
{
    ...
    public class CustomerServiceTests
    {
        ...
        public async Task StartOnboarding_ShouldThrow_When_EmailExists()
        {
            ...
            repo.Setup(r => r.GetByEmailAsync(It.IsAny<string>(), It.IsAny<CancellationToken>())).ReturnsAsync(new Customer());
            ...
            await Assert.ThrowsAsync<InvalidOperationException>(() => svc.StartOnboardingAsync(new CustomerOnboarding.Api.DTOs.CreateCustomerRequest { PhoneNumber = "08031234567", Email = "a@b.com", Password = "pass", StateId = 1, LgaId = 1 }, CancellationToken.None));
        }
    }
}
